...
public class DNA {
    // draw a black-outlined shape representing a single base of a template sequence
    public _________ void templateShape(double x, double y, double size) {
        ________[] px = { ____________________________________________ };
        ________[] py = { y + size, y + size, y - size, y - 2 * size, y - size };
        StdDraw.filledPolygon(_______, _______);
        StdDraw.setPenColor(Color.BLACK);
        StdDraw.polygon(_______, _______);
    }

    // draw a black-outlined shape representing a single base of a complement sequence
    public static _________ complementShape(double x, double y, double size) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            complementShape(_________, -0.5, 0.5);
